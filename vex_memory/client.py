...
from .client_autotuning import AutoTuningMixin


class VexMemoryClient(AutoTuningMixin):
    ...
    def __init__(
        ...
        # Initialize auto-tuning mixin
        AutoTuningMixin.__init__(self)
    ...
    def build_context(
        ...
        # Get active weights (user override or learned weights)
        active_weights = self._get_active_weights(weights, namespace)
        ...
        if active_weights is not None:
            payload["weights"] = active_weights
